...
### Fix number of executors: 10, executor memory: 3G. Overall, the total capacity of executors is 30GB.
### A day of tweets is ~1.44 GB compressed (in 1440 files). We assume after extracting, the amount of data is tripled (assume 5GB)
### 1-day data: 4.5GB
...
### 7-day data: 31.5GB (Assumption: The plot should be bumped at this point.)
...
tweets = spark.read.json(PATH_1_DAY) \
