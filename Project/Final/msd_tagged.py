...
lastfm_1 = lastfm.select(col('track_id'),col('similars'),col('tags'))

#Join tables
df_joined = df1.join(lastfm_1, 'track_id')
...
#Write as json
df_joined.write.format('json').save('/user/s2733226/project/msd_lastfm_tags_1')
